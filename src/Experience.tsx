              ...
              <ol className="relative space-y-8">
                  <li className="relative flex items-start">
                      <div className="absolute -left-5.5 bg-zinc-900 text-black w-12 h-12 flex items-center justify-center rounded-full">
                            <img src="/src/images/svg.svg" alt="Show more" className="w-64 h-64 scale-170 object-contain" />
                      </div>
                  ...
                  <li className="relative flex items-start">
                      <div className="absolute -left-5.5 bg-zinc-900 text-black w-12 h-12 flex items-center justify-center rounded-full">
                        <img src="/src/images/Projects.svg" alt="Show more" className="w-32 h-32 scale-80 object-contain" />
                      </div>
